      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 p-4 bg-gray-50 rounded-lg border">
          <div className="grid grid-cols-2 sm:flex sm:flex-row gap-2 items-center w-full md:w-auto">
            ...
            <button
              onClick={fetchData}
              className="col-span-2 sm:col-auto w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-semibold text-sm"
            >
              <RefreshCw size={18} />
              <span>Refresh</span>
            </button>
          ...
          <button
            ...
            className="w-full md:w-auto flex items-center justify-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 font-semibold text-sm"
          >
            <FileText size={16} />
            <span>PDF</span>
          </button>
          ...
          <div className="overflow-x-auto border rounded-lg">
            <table className="w-full text-sm">
              <thead className="bg-gray-100 text-gray-600">
                <tr>
                  <th className="p-3 text-left font-semibold sticky left-0 bg-gray-100 z-10 border-r">
                    Nama Siswa
                  </th>
                  {aspects.map((aspect) => (
                    <th
                      key={aspect.id}
                      className="p-3 font-semibold text-center border-l"
                    >
                      {aspect.name}
                    </th>
                  ))}
