    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-green-50/50 p-8 text-center">
      <div className="w-full max-w-6xl">
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          {/* Monitoring */}
          <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-gray-200 bg-gray-50 p-6 cursor-not-allowed">
            <div className="text-gray-400">
              <IconMonitoring />
            </div>
            <h2 className="text-xl font-semibold text-gray-400">Monitoring</h2>
            <p className="text-sm text-gray-400">(Dalam Pengembangan) Pantau laporan siswa.</p>
          </div>
        </div>
      </div>
    </main>
