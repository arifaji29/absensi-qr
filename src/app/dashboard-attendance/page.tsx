                  ...
                  {classes.map((cls) => (
                    <tr key={cls.id} className="hover:bg-gray-50 border-b last:border-b-0">
                      ...
                      <td className="p-4 text-center">
                        <Link href={`/attendance?class_id=${cls.id}`} className="inline-block px-5 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 text-xs font-semibold shadow-sm">
                          Mulai Absensi
                        </Link>
                      </td>
                    </tr>
